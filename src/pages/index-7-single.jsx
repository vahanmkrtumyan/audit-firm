...
import About from "../section/Home7/About";
...
import Growth from "../section/Home7/Growth";
...
function Home7Single() {
    return (
        <>
        <div className="page-wrapper gray-bg">
            <Layout HeaderStyle="sevensingle" FooterStyle="six">
                <Banner />               
                <About />               
                <Service />               
                <Choose />               
