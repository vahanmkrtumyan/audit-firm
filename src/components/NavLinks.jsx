            ...
            <li className="dropdown"><Link to="#">Home</Link>
              <div className="dropdown-btn"><i className="fa fa-angle-down"></i></div>
                <ul>
                  ...
                  <li className="dropdown"><Link to="#">Single Styles</Link>
                    <ul>
                      <li><Link to="/index-1-single">Single Styles One</Link></li>
                      <li><Link to="/index-2-single">Single Styles Two</Link></li>
                      <li><Link to="/index-3-single">Single Styles Three</Link></li>
                      <li><Link to="/index-4-single">Single Styles Four</Link></li>
                      <li><Link to="/index-5-single">Single Styles Five</Link></li>
                      <li><Link to="/index-6-single">Single Styles Six</Link></li>
                      <li><Link to="/index-7-single">Single Styles Seven</Link></li>
                    </ul>
                  </li>
                  <li className="dropdown"><Link to="#">Dark Styles</Link>
                    <ul>
                      <li><Link to="/index-1-dark">Dark Styles One</Link></li>
                      <li><Link to="/index-2-dark">Dark Styles Two</Link></li>
                      <li><Link to="/index-3-dark">Dark Styles Three</Link></li>
                      <li><Link to="/index-4-dark">Dark Styles Four</Link></li>
                      <li><Link to="/index-5-dark">Dark Styles Five</Link></li>
                      <li><Link to="/index-6-dark">Dark Styles Six</Link></li>
                      <li><Link to="/index-7-dark">Dark Styles Seven</Link></li>
                    </ul>
                  </li>
                </ul>
              </li>
